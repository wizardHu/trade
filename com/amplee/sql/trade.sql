...
) ENGINE=InnoDB AUTO_INCREMENT=168 DEFAULT CHARSET=utf8 COMMENT='记录每次买';
...
) ENGINE=InnoDB AUTO_INCREMENT=259 DEFAULT CHARSET=utf8 COMMENT='每次正常买卖的记录';
...
CREATE TABLE `tb_jump_queue_history_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `symbol_idx` (`symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=378 DEFAULT CHARSET=utf8 COMMENT='价格跳跃历史表';
...
CREATE TABLE `tb_jump_queue_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `symbol_idx` (`symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='价格跳跃表';
...
CREATE TABLE `tb_kline_record` (
  ...
  `vol` decimal(30,10) DEFAULT NULL COMMENT '以报价币种计量的交易量',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='提前卖的记录';
...
CREATE TABLE `tb_stop_loss_history_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `symbol_idx` (`symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=245 DEFAULT CHARSET=utf8 COMMENT='止损的历史记录';
...
CREATE TABLE `tb_stop_loss_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `symbol_idx` (`symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='止损卖出的记录';
...
CREATE TABLE `tb_transaction_config` (
  ...
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='交易对配置';
